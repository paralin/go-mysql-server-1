...
func NewHandler(le *logrus.Entry, e *sqle.Engine, sm *SessionManager, rt time.Duration, disableMultiStmts bool, maxLoggedQueryLen int, listener ServerEventListener) *Handler {
	return &Handler{
		le:                le,
		e:                 e,
		sm:                sm,
