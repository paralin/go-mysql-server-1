...
func (h *Handler) NewConnection(c *mysql.Conn) {
	...
	h.le.WithField(sqle.ConnectionIdLogField, c.ConnectionID).WithField("DisableClientMultiStatements", c.DisableClientMultiStatements).Infof("NewConnection")
}
...
func (h *Handler) ConnectionClosed(c *mysql.Conn) {
	...
	h.le.WithField(sqle.ConnectionIdLogField, c.ConnectionID).Infof("ConnectionClosed")
}
